...
! ================PFT/PC htop
      ...
      IF (p_is_io) THEN
         ...
         CALL read_5x5_data_pft (dir_5x5, fname, grid_pft, trim(DEF_rawdata%cdepth%vname), cdepth, lb=1, ub=8) ! consider the lower and upper bound of dataset for 8 tree PFTs
