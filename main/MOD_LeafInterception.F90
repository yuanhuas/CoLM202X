...
!----------------
   ...
   real(r8) :: qflx_irrig_sprinkler_tmp

      IF ( present(qflx_irrig_sprinkler) ) THEN
         qflx_irrig_sprinkler_tmp = qflx_irrig_sprinkler
      ELSE
         qflx_irrig_sprinkler_tmp = 0
      ENDIF
      ...
      IF (DEF_Interception_scheme==1 .or. present(urban_call)) THEN
         CALL LEAF_interception_CoLM2014 (deltim,dewmx,forc_us,forc_vs,chil,sigf,lai,sai,tair,tleaf,&
                                             prc_rain,prc_snow,prl_rain,prl_snow,bifall,qflx_irrig_sprinkler_tmp,&
                                             ldew,ldew_rain,ldew_snow,z0m,hu,pg_rain,&
                                             pg_snow,qintr,qintr_rain,qintr_snow)
      ...
      ELSEIF (DEF_Interception_scheme==2) THEN
         CALL LEAF_interception_CLM4 (deltim,dewmx,forc_us,forc_vs,chil,sigf,lai,sai,tair,tleaf,&
                                             prc_rain,prc_snow,prl_rain,prl_snow,qflx_irrig_sprinkler_tmp,&
                                             ldew,ldew_rain,ldew_snow,z0m,hu,pg_rain,&
                                             pg_snow,qintr,qintr_rain,qintr_snow)
...
#endif
   real(r8) pg_rain_tmp, pg_snow_tmp, qflx_irrig_sprinkler_tmp
